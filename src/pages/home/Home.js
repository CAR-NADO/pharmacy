    ...
    return (
        <div>
            ...
            <div className="paragraph-1">
                <p>Thank you for visiting OnlinePharmas.com – the US’s One Stop Shop for Top Quality <span>ED Medication,</span> <span>Anxiety Medication</span> and <span>Painkillers.</span> </p>
                </div>
                <div className="paragraph-2">
                <p>If you are visiting for the first time and you want to buy cheap sleeping tablets online in the USA you have come to the right place! We accept payments on all major platforms <span>PayPal, (Western Union/Bitcoin ) and Bank Transfer</span> – we offer the best deals on bulk orders.</p>
                </div>
                <div className="paragraph-3">
                <p>After payment is received goods are sent immediately in plain padded envelopes, and delivery to locations in the USA takes just 3 – 4 working days!</p>
                </div>
            </div>
